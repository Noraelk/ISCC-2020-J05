...
echo "<h3>Il reste {$quantite} produits en stock </h3>";
  ...
  //phrase 3//
echo "<h3>Le produit {$nom_produiy} est de couleur {$couleur}</h3>";
  
//opération simple//

//phrase 1//
echo "<h4>Acheter 3 produit couterait {$cout}</h4>";
...
echo "<p>Il ne reste plus que {$qauntite} produits en magasin</p>";
}
elseif($quantite==1){
